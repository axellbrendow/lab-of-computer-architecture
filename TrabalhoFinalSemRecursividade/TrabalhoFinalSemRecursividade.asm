...
LOOP_MOVIMENTO_NORMAL
	...
	GOTO LOOP_SUBIDA
	GOTO LOOP_DESCIDA
LOOP_MOVIMENTO_NORMAL_LEDS
	; skip if bit = 1. -> (up = 0, down = 1)
	BTFSS BIT_STATUS_MOVIMENTO
	CALL LOOP_SUBIDA_LEDS
	BTFSC BIT_STATUS_MOVIMENTO
...
LIGAR_LED_T_SUBIDA
	...
	;CALL LIGAR_LED_T
	BSF BIT_STATUS_MOVIMENTO ; movimento down
RETURN
...
LIGAR_LED_A4_DESCIDA
	;CALL DESLIGAR_LED_T
	;CALL LIGAR_LED_A4
	BCF BIT_STATUS_MOVIMENTO ; movimento up
RETURN
...
GOTO LOOP_MOVIMENTO_NORMAL_LEDS ; vai para o "menu" dos loopings
...
GOTO LOOP_MOVIMENTO_NORMAL_LEDS
