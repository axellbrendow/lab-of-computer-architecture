...
import static Util.AxellIO.LINE_SEPARATOR;
...
public class MyString
{
    ...
    {
        return exists(data) && /*data.charAt(0) != '.' &&*/ MyString.countChars('.', data) <= 1;
    }
